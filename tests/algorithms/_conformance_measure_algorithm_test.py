...
class MyTestCase(unittest.TestCase):
    ...
    def test_first_net_first_log_example(self):
        ...
        run_1_event_1: EventForRun = EventForRun("Run1Event1", self.net_1_transition_start)
        run_1_event_2: EventForRun = EventForRun("Run1Event2", self.net_1_transition_1)
        run_1_event_3: EventForRun = EventForRun("Run1Event3", self.net_1_transition_2a)
        run_1_event_4: EventForRun = EventForRun("Run1Event4", self.net_1_transition_2b)
        run_1_event_5: EventForRun = EventForRun("Run1Event5", self.net_1_transition_3)
        ...
        run_2_event_1: EventForRun = EventForRun("Run2Event1", self.net_1_transition_start)
        run_2_event_2: EventForRun = EventForRun("Run2Event2", self.net_1_transition_return)
        run_2_event_3: EventForRun = EventForRun("Run2Event3", self.net_1_transition_1)
        run_2_event_4: EventForRun = EventForRun("Run2Event4", self.net_1_transition_2b)
        run_2_event_5: EventForRun = EventForRun("Run2Event5", self.net_1_transition_2a)
        run_2_event_6: EventForRun = EventForRun("Run2Event6", self.net_1_transition_3)
    ...
    def test_second_net_second_log(self):
        ...
        :return:
        """
        run_1_event_1: EventForRun = EventForRun("Run1Event1", self.net_2_transition_prep1)
        run_1_event_2: EventForRun = EventForRun("Run1Even2", self.net_2_transition_prep2)
        run_1_event_3: EventForRun = EventForRun("Run1Event3", self.net_2_transition_prep3)
        run_1_event_4: EventForRun = EventForRun("Run1Event4", self.net_2_transition_a1)
        run_1_event_5: EventForRun = EventForRun("Run1Event5", self.net_2_transition_a2)
        run_1_event_6: EventForRun = EventForRun("Run1Event6", self.net_2_transition_a3)
        run_1_event_7: EventForRun = EventForRun("Run1Event7", self.net_2_transition_final)
