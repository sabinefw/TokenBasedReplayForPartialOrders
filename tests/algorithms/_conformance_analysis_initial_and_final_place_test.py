...
from src.TokenBasedReplayForPartialOrders.algorithms._conformance_analysis_initial_and_final_place import calculate_token_analysis_for_initial_and_final_place
...
from src.TokenBasedReplayForPartialOrders.structures._workflow_net import PlaceWorkflowNet, TransitionWorkflowNet, WorkflowNet
...
class MyTestCase(unittest.TestCase):
    ...
    def test_first_run_example(self):
        ...
        event_1: EventForRun = EventForRun("Event 1", self.transition_3)
        event_2: EventForRun = EventForRun("Event 2", self.transition_2)
        event_3: EventForRun = EventForRun("Event 3", self.transition_1)
        event_4: EventForRun = EventForRun("Event 4", self.transition_1)
        event_5: EventForRun = EventForRun("Event 5", self.transition_4)
        event_6: EventForRun = EventForRun("Event 6", self.transition_1)
        event_7: EventForRun = EventForRun("Event 7", self.transition_2)
        event_8: EventForRun = EventForRun("Event 8", self.transition_3)
    ...
    def test_second_example_run(self):
        ...
        # Prepare run for test
        event_1: EventForRun = EventForRun("Event 1", self.transition_3)
        event_2: EventForRun = EventForRun("Event 2", self.transition_4)
        event_3: EventForRun = EventForRun("Event 3", self.transition_3)
        event_4: EventForRun = EventForRun("Event 4", self.transition_4)
        event_5: EventForRun = EventForRun("Event 5", self.transition_3)
        event_6: EventForRun = EventForRun("Event 6", self.transition_4)
        event_7: EventForRun = EventForRun("Event 7", self.transition_4)
        event_8: EventForRun = EventForRun("Event 8", self.transition_3)
        partial_order: DiGraph = DiGraph()
    ...
    def test_third_example_run(self):
        ...
        """
        # Prepare run for test
        event_1: EventForRun = EventForRun("Event 1", self.transition_1)
        event_2: EventForRun = EventForRun("Event 2", self.transition_1)
        event_3: EventForRun = EventForRun("Event 3", self.transition_1)
        event_4: EventForRun = EventForRun("Event 4", self.transition_1)
        event_5: EventForRun = EventForRun("Event 5", self.transition_1)
        event_6: EventForRun = EventForRun("Event 6", self.transition_1)
        event_7: EventForRun = EventForRun("Event 7", self.transition_1)
        event_8: EventForRun = EventForRun("Event 8", self.transition_1)
        partial_order: DiGraph = DiGraph()
        partial_order.add_edges_from([(event_1, event_2), (event_2, event_4), (event_2, event_4), (event_2, event_5),
                                      (event_5, event_6), (event_4, event_6), (event_3, event_6), (event_6, event_7),
                                      (event_6, event_8)])
